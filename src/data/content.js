...
export const waLink = (text) => `https://wa.me/${phone}?text=${encodeURIComponent(text ?? "")}`
...
export const contactInfoList = [
  ...
  "Metros aproximados",
  "Fotos o video del terreno",
]

export const contactCopy = {
  helper: "Déjanos tus datos y coordinamos por WhatsApp según disponibilidad y evaluación del terreno.",
}
